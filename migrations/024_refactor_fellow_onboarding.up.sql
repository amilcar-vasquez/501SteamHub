-- UP: Refactor Fellow onboarding system to improve data integrity
-- Replace FullName duplication with FirstName/LastName
-- Add MOE Identifier requirement to applications
-- Add traceability and verification tracking
...
-- Step 7: Index for verification lookups
